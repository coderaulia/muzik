...
import io.github.coderaulia.muzikplayer.utils.*
...
sealed interface AlbumCover {
    ...
    val colorScheme: MuzikTheme.ColorSchemeContainer
    ...
    data class File(
        ...
        override val colorScheme: MuzikTheme.ColorSchemeContainer =
            MuzikTheme.colorScheme(colorPalette.map { it.hsb() })
